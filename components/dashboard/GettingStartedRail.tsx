    ...
    <Card className="border-cyan-500/20 bg-card/50">
      <CardHeader className="pb-3">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <Badge variant="outline">Next best step</Badge>
        </div>
      </CardHeader>
      <CardContent className="space-y-3 text-sm text-muted-foreground">
        <div className="text-sm text-muted-foreground">{next.helper}</div>
        <Button asChild size="sm" className="neon-border hover:glow-effect" onClick={() => track('onboarding_started', { source: 'dashboard_getting_started' })}>

...
export const UserSettingsSchema = z.object({
  ...
  onboarding_v2_step: z.number().int().min(1).max(5).optional(),
  onboarding_workflow: z.enum(['pitch', 'report', 'daily_shortlist']).optional(),
  onboarding_started_at: z.string().datetime().optional(),

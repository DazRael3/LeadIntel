...
export const COMPETITOR_MATRIX: CompetitorMatrixEntry[] = [
  {
    ...
    theyDoBetter: 'Signal breadth, named contact depth, workflow automation, visible proof, trust maturity.',
  ...
  },
  {
    ...
    theyDoBetter: 'Contact depth, buying groups, CRM depth, intent breadth, procurement/trust maturity.',
  ...
  },
  {
    ...
    name: 'LeadIntel',
    threatScore: 7.3,
    threatSummary: 'Strong on clarity, explainability, and action packaging; intentionally not a giant contact database.',
    leadIntelWins: 'Message clarity, no-signup evaluation, transparent pricing, explainable scoring + momentum.',
    theyDoBetter: 'Signal breadth, named contact depth, broader identity capture, enterprise trust maturity.',
  },
] as const
...
export const COMPARE_PAGES: ComparePage[] = [
  {
    ...
    table: [
      ...
      { dimension: 'Momentum visibility', leadintel: 'Yes (rising/steady/cooling + contributing signals)', competitor: varies() },
      { dimension: 'First-party intent', leadintel: 'When observed: domain-matched activity + freshness + intent label', competitor: varies() },
      ...
      { dimension: 'Account watchlists', leadintel: 'Yes', competitor: varies() },
      {
        ...
        leadintel: 'Persona + buying-group recommendations (heuristic), not a named contact database',
        competitor: varies(),
      },
      {
        dimension: 'Action packaging',
        leadintel: 'Action center: variants + saved briefs + webhooks/exports for handoff',
        competitor: varies(),
      },
      { dimension: 'Saved account briefs', leadintel: 'Yes (save, regenerate, copy/export)', competitor: varies() },
